...
public class VistaController {
    ...
    public VistaController(ProductoService productoService, UsuarioService usuarioService, PedidoService pedidoService) {
        this.productoService = productoService;
        this.usuarioService = usuarioService;
        this.pedidoService = pedidoService;
    }

    private void agregarPedidoYUsuarioAlModelo(Model model, Principal principal) {
        Pedido pedido = null;
        ...
        if (principal != null) {
            ...
            if (userOptional.isPresent()) {
                ...
                pedido = pedidoService.obtenerOCrearPedido(usuario.getId());
            }
        }
    ...
    public String verProductos(Model model, Principal principal) {
        ...
        agregarPedidoYUsuarioAlModelo(model, principal);
        return "index";
    }
